                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    suffixIcon: IconButton(
                                        icon: Icon(Icons.account_circle_sharp, color: Color(0xFFdb9e1f),),
                                        onPressed: () {
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    suffixIcon: IconButton(
                                        icon: Icon(Icons.email, color: Color(0xFFdb9e1f),),
                                        onPressed: () {
                                ...
                                TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    suffixIcon: IconButton(
                                        icon: Icon(Icons.local_phone_rounded, color: Color(0xFFdb9e1f),),
                                        onPressed: () {
                                  ...
                                  decoration: InputDecoration(
                                    suffixIcon: IconButton(
                                        icon: Icon(_isObscure3
                                            ? Icons.visibility
                                            : Icons.visibility_off, color: Color(0xFFdb9e1f),),
                                        onPressed: () {
                                          setState(() {
